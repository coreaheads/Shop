					...
					<ul class="nav navbar-nav" id="nav navbar-nav">
						...
						<li class="panel panel-default" id="dropdown"><a
							data-toggle="collapse" href="#dropdown-lvl1"> <span
								class="glyphicon glyphicon-user"></span> 회원 <span class="caret"></span>
						</a> <!-- Dropdown level 1 -->
						...
						<li class="panel panel-default" id="dropdown"><a
							data-toggle="collapse" href="#dropdown-lvl2"> <span
								class="glyphicon glyphicon-shopping-cart"></span> 상품관리 <span
								class="caret"></span>
						</a> <!-- Dropdown level 1 -->
						...
						<li><a href="BoardConfig.do?mode=list&page=1"><span
						
								class="glyphicon glyphicon-folder-open"></span>게시판관리</a></li>
