<div class="col-md-12"><%@ page language="java"
...
function myFunction(item){
							...
							<div class="product-information">
								...
								<form action="memberCartInsert.do" method="post">
									<span> <span style="color: #ce1710;">할인된 가격 : <i>${item.sale }원</i></span>
										...
										value="${myInfo.member_id }"> <input type="hidden"
										name="itemId" value="${item.idx }">
	...
	<a href="itemDelete.do?idx=${item.idx}">삭제</a> <a
		href="item.do?idx=${item.idx}&mode=update">update</a>
