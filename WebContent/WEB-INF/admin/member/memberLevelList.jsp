...
<script type="text/javascript">
	...
	function modifyMemberLevel(member_level_no){
		...
		var data = "member_level_no="+member_level_no +"&member_level_name="+$("#member_level_name").val();
		var message = "수정";		
		if($('#member_level_name').val().length>1){
			ajaxProcess(url,data,message);
		}else{
			alert("레벨명 적어줘");
			return false;
      ...
      <table class="table">
		...
		<c:forEach items="${list}" var="list">
			<tr>
				...
				<td><input type="text" name="member_level_name" id="member_level_name" value="${list.member_level_name}"></td>
