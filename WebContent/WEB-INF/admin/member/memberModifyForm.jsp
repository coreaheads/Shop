	...
	<div class="container">
		...
		<div class="row row-centered">
			...
			<div class="col-md-12 col-centered">
				...
				<form:form commandName="member" id="registMember" role="form" action="memberModifyOK.do" method="post" >		  	
				...
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-md-12">
							<label for="member_level_no">회원 Level</label>
						    <select class="form-control" name="member_level_no" id="member_level_no">
								    <c:forEach items="${memberLevel}" var="memberLevel">						    	
								    	<option value="${memberLevel.member_level_no}" ${memberLevel.member_level_no eq member.member_level_no ? 'selected' : '' }> ${memberLevel.member_level_name}</option>
								    </c:forEach>
            				</select>						
						</div> 						    
